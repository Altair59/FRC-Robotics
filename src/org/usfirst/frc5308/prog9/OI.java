...
public class OI {
    ...
    public OI() {
        ...
        strentchin1button2 = new JoystickButton(joystick2, 3);
        strentchin1button2.whileHeld(new strentcherIn1());
        strentchout1button2 = new JoystickButton(joystick2, 5);
        ...
        shootlowspeedstopbutton = new JoystickButton(joystick1, 2);
        ...
        shoothighspeedstartbutton = new JoystickButton(joystick1, 5);
        shoothighspeedstartbutton.whenPressed(new shoothighspeedstart());
        blendupButton = new JoystickButton(joystick1, 11);
        blendupButton.whileHeld(new blendup());
        blenddownButton = new JoystickButton(joystick1, 12);
        blenddownButton.whileHeld(new blenddown());
        JoystickButton passButton = new JoystickButton(joystick1, 8);
        passButton.whileHeld(new pass());
        liftdownButton = new JoystickButton(joystick1, 10);
        liftdownButton.whileHeld(new liftdown());
        liftupButton = new JoystickButton(joystick1, 9);
        liftupButton.whileHeld(new liftup());
        shootlowspeedstartbutton = new JoystickButton(joystick1, 6);
        shootlowspeedstartbutton.whenPressed(new shootlowspeedstart());
        JoystickButton shootspeed2button = new JoystickButton(joystick1,3);
        shootspeed2button.whenPressed(new shootspeed2());
        JoystickButton shootspeed4button= new JoystickButton(joystick1,4);
        shootspeed4button.whenPressed(new shootspeed4());
